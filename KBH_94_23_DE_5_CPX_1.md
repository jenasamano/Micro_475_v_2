KBH\_94\_23\_DE\_5\_CPX\_1
================

``` r
library(readr)
KBH_94_23_DE_5_CPX_1 <- read_csv("KBH_94_23_DE_5_CPX_1.csv")
```
...
``` r
View(KBH_94_23_DE_5_CPX_1)
```

``` r
mol_numbers <- mutate(KBH_94_23_DE_5_CPX_1, phos_ox/141.943,
                  sil_ox/53.083,
                  tit_ox/79.865,
                  alu_ox/101.961,
                  cro_ox/99.993,
