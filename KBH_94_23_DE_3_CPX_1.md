...
``` r
library(readr)
KBH_94_23_DE_3_CPX_1 <- read_csv("KBH_94_23_DE_3_CPX_1.csv")
```
...
``` r
View(KBH_94_23_DE_3_CPX_1)
```

# Step 1

``` r
mol_numbers <- mutate(KBH_94_23_DE_3_CPX_1, phos_ox/141.943,
                  sil_ox/53.083,
                  tit_ox/79.865,
                  alu_ox/101.961,
                  cro_ox/99.993,
...
### These are Pyrixenes so 6/the sum’d number from the sum\_row data
