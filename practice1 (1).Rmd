...
```{r}
adelie_plot_1 <- ggplot(penguins,aes(x=bill_length_mm))+
  geom_histogram()
adelie_plot_1

adelie_plot_2 <- ggplot(penguins,aes(x=bill_depth_mm))+
  geom_histogram()
adelie_plot_2

adelie_plot_3 <- ggplot(penguins, aes(x=flipper_length_mm))+
  geom_histogram()
adelie_plot_3

adelie_plot_4 <- ggplot(penguins, aes(x=body_mass_g))+
  geom_histogram()
adelie_plot_4
```
...
adelie_plot_4 <- ggplot(penguins, aes(x=body_mass_g))+
  geom_histogram(color="black", fill="white", binwidth = 150)
adelie_plot_4
